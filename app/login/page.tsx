    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="modern-card animate-fade-in">
          ...
          <CardContent className="space-y-4">
            <Button
              ...
              className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white h-12 rounded-lg font-medium"
            >
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500">Secure authentication powered by Discord OAuth</p>
        </div>
      </div>
    </div>
  )
