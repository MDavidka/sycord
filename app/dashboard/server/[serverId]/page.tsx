...
import { Shield, MessageSquare, Gift, LinkIcon, Filter, Hash, ChevronDown, Home, Send, Link2Icon as LinkIcon2, ArrowRight, Plus, Copy, Check, LogIn, ArrowLeft, Clock, AlertTriangle, Info, Eye, Bot, Webhook, MessageCircle, FileText, Zap, UserCheck, Users, Crown, Package, Settings, Lock, EyeOff, Megaphone } from 'lucide-react'
...
export default function ServerConfigPage() {
  ...
  useEffect(() => {
    if (session && serverId) {
      ...
      fetchAppSettings()
      fetchAnnouncements()
      fetchServerStats() // Add this line
    }
  }, [session, serverId])
                  ...
                  <div className="flex items-center space-x-4 text-xs">
                    <div className="text-center">
                      <div className="font-bold text-white">
                        {serverStatsLoading ? "..." : (serverConfig.server_stats?.total_members || 0)}
                      </div>
                      <div className="text-gray-400">Members</div>
                    </div>
                    <div className="text-center">
                      <div className="font-bold text-white">
                        {serverStatsLoading ? "..." : (serverConfig.server_stats?.total_bots || 0)}
                      </div>
                      <div className="text-gray-400">Bots</div>
                    </div>
                    <div className="text-center">
                      <div className="font-bold text-white">
                        {serverStatsLoading ? "..." : (serverConfig.server_stats?.total_admins || 0)}
                      </div>
